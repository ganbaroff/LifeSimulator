// Исправленная версия CharacterCreationScreen с правильным дизайном и логикой
...
const CharacterCreationScreenFixed: React.FC = () => {
...
export default CharacterCreationScreenFixed;
